...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "x4 - Со стажем управления до 2 лет"))
        self.label_5.setText(_translate("MainWindow", "x5 - Со стажем управления от 5 до 10 лет"))
        self.label_6.setText(_translate("MainWindow", "x6 - Со стажем управления свыше 15 лет"))
        self.label_7.setText(_translate("MainWindow", "x7 - ДТП при нарушении ПДД хотя бы одним водителем"))
        self.label_8.setText(_translate("MainWindow", "x8 - ДТП из-за неудовлетворительного состояния дорог"))
        self.label_9.setText(_translate("MainWindow", "x9 - ДТП с участием водителя в алкогольном и/или наркотическом опьянении"))
        self.label_10.setText(_translate("MainWindow", "x10 - ДТП из-за неудовлетворительного дорожного покрытия (вода, лед, снег)"))
        self.label_11.setText(_translate("MainWindow", "x11 - ДТП на дорогах федерального значения"))
        self.label_12.setText(_translate("MainWindow", "x12 - ДТП на дорогах регионального или муниципального значения"))
        self.label_13.setText(_translate("MainWindow", "x13 - ДТП на дорогах местного значения"))
        self.label_14.setText(_translate("MainWindow", "x14 - ДТП на платных автомобильных дорогах"))
        self.label_15.setText(_translate("MainWindow", "x15 - ДТП на железнодорожных переездах"))
