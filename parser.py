...
AMOUNT_OF_FACS = 6
# init functions here
FUNCTIONS = [lambda x: 1] * AMOUNT_OF_VERTICES
...
matrixOfFacs = sheet1.get_values((2, AMOUNT_OF_VERTICES + 2), (AMOUNT_OF_VERTICES + AMOUNT_OF_FACS + 1, AMOUNT_OF_VERTICES + AMOUNT_OF_FACS + 1))
